...
public class CheckBeingFired : DecoratorNode
{
    ...
    public List<VehicleSide> shooterToFind;
    //[Range(0.0f, 100.0f)]
    ...
    protected override State OnUpdate()
    {
        ...
        if (!shooterToFind.Contains(hit.gameObject.GetComponent<BulletScript>().bulletOwner)) return State.Success; //doesn't have bullet script with the shooter on the same side? do nothing
